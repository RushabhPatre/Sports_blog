...
<head>
  ...
  <link href="assets/css/image_style.css" rel="stylesheet">
    ...
    <div class="container-fluid">
      ...
      <div class="row justify-content-center">
        <div class="col-xl-11 d-flex align-items-center">
          <h1 class="logo mr-auto"><a href="index.php"><span class="green-color">Sports</span>Blog</a></h1>
          ...
          <nav class="nav-menu d-none d-lg-block">
            <ul>
              ...
              <li><a href="animation.html">Today's Feature</a></li>
            </ul>
          </nav><!-- .nav-menu -->
        </div>
      </div>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-links">
            ...
            <button style="background: #18d26e;border: 0;padding: 10px 30px;color: #fff;transition: 0.4s;cursor: pointer;" onclick="getLocation()">Where am I?</button>
            <p id="demo"></p>
            <form action="mail.php" method="post" >
              <input style="background: #18d26e;border: 0;padding: 10px 30px;color: #fff;transition: 0.4s;cursor: pointer;" type="submit" name="submit" value="Subscribe to our Newsletter">
            </form>
          </div>
